...
\item Le Client : L'équipe en charge du contrat devra densifié la remise de rapports au client afin d'assurer un meilleur service. La rédaction de ces rapports sera grandement facilitée grâce aux mots clefs remplis pour chaque projet. D'autre part, le client pourra être lui aussi tenu si il le souhaite de rédiger un rapport 
\end{itemize}
