...
\footnotetext{Source : site internet SPIE Sud-Est - \tt{http://j.mp/xTveeD}}
...
\begin {center}
\includegraphics[width=\textwidth]{png_generaux/SimplificationProcessusDeMaintenanceSPIE.png}
\end {center}
...
\footnotetext{Site internet Carl Software : \tt{http://j.mp/carl-software}}

\item Optimaint\footnotemark

% Site internet : http://www.europrint-gmao.fr
\footnotetext{Site internet Optimaint : \tt{http://j.mp/europrint}}
...
\item Mot clefs : à l'image du réseau social twitter il sera nécessaire d'adjoindre des ``tags'' ou mots-clés à chaque contrat de maintenance. Il sera donc possible ensuite de rechercher des contrats de maintenance par mots clefs.
